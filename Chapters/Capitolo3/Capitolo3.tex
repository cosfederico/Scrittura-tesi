...
\subsubsection{Registrazione dello schermo}
...
Per l'estrazione delle espressioni facciali non è necessario l'utilizzo del segnale RAW della webcam, per cui le registrazioni sono salvate in formato \verb|.mp4| compresso, per ridurre lo spazio richiesto per memorizzare i dati salvati.
